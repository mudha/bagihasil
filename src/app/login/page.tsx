...
export default function LoginPage() {
    return (
        <div className="relative flex min-h-dvh w-full flex-col items-center justify-center bg-[radial-gradient(circle_at_top_left,#ccfbf1_0%,#f8fafc_38%,#ffffff_100%)] px-4 dark:bg-gray-900">
