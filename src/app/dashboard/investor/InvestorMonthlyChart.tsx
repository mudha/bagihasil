    ...
    return (
        <Card className={`rounded-lg border-teal-900/10 bg-white shadow-sm ${className || ""}`}>
            <CardHeader className="p-4 sm:p-6">
                <CardTitle className="text-base font-black text-slate-950">Pendapatan Bulanan</CardTitle>
                <p className="text-sm text-slate-500">Bagi hasil yang diterima per periode</p>
            </CardHeader>
